...
void invmsMPU9250GyroRead(int16_t *ps16X, int16_t *ps16Y, int16_t *ps16Z) {
    uint8_t i;
...
void invmsMPU9250AccelRead(int16_t *ps16X, int16_t *ps16Y, int16_t *ps16Z) {
    uint8_t i;
    int16_t InBuffer[3] = {0};
    static int32_t OutBuffer[3] = {0};
    static MPU9250_AvgTypeDef MPU9250_Filter[3];
...
void invmsMPU9250MagRead(int16_t *ps16X, int16_t *ps16Y, int16_t *ps16Z) {
    uint8_t i;
    int16_t InBuffer[3] = {0};
    static int32_t OutBuffer[3] = {0};
    static MPU9250_AvgTypeDef MPU9250_Filter[3];
